...
export class UtilityService {
  ...
  getStrategySelections(): OptionsStrategy[] {
    ...
    {
      Id: 11,
      Name: "PutRatioBackSpread",
      Display: "Put Ratio Back Spread"
    }
    ];
  }
  ...
  //     }, {
  //       Id: 13,
  //       Name: "LongCallButterflySpread",
  //       Display: "Long Call Butterfly Spread"
  //     }, {
  //       Id: 14,
  //       Name: "MarriedPut",
  //       Display: "Married Put"
  ...
  //       Id: 16,
  //       Name: "CoveredCall",
  //       Display: "Covered Call"
  //     }
  //     , {
  //       Id: 17,
  //       Name: "ProtectiveCollar",
  //       Display: "Protective Collar"
  //     }
  //   ];
  // }
  ...
  getListOfLegs(optionStrategy: string) {
    switch (optionStrategy) {
      case "IronCondor":
        return ["Buy Put", "Sell Put", "Sell Call", "Buy Call"];
      case "Straddle":
        return ["Buy Call", "Buy Put"];
      case "BullCallSpread":
        return ["Buy Call", "Sell Call"];
      case "BearCallSpread":
        return ["Sell Call", "Buy Call"];
      case "BullPutSpread":
        return ["Buy Put", "Sell Put"];
      case "BearPutSpread":
        return ["Sell Put", "Buy Put"];
      case "CalendarPutSpread":
        return ["Sell Put", "Buy Put"];
      case "CalendarCallSpread":
        return ["Sell Call", "Buy Call"];
  ...
  getHVPredictionSelections(): OptionsStrategy[] {
    return [{
      Id: 5,
      Name: "Select options",
      Display: "Select options"
  ...
  getBehaviourPredictionSelections(): OptionsStrategy[] {
    return [{
      Id: 5,
      Name: "Select options",
      Display: "Select options"
  ...
  getSentimentPredictionSelections(): OptionsStrategy[] {
    return [{
      Id: 5,
      Name: "Select options",
      Display: "Select options"
  ...
  getSampleContract(optionStrategy: string, symbol: string, currentPrice: number): Observable<any[]> {
    return this.optionsService.getExpiryDates(symbol).pipe(mergeMap(optExpiry => {
      ...
      // console.log(symbol, lastExpiryDate);
