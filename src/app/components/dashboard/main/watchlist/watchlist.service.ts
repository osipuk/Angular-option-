...
export class WatchlistService {
    ...
    /** POST: Get WatchList Result */
    getWatchListData(requestObj: any): Observable<any> {
        let config = this.configService.readConfig();
        if (config) {
            this.baseUrl = config.apiUrl;
            this.serverApiKey = config.serverApiKey;
        ...
        return this.http.post<any>(this.baseUrl + "/optionapi/v1/Watchlist/GetWatchlists", requestObj, {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
                //'ApiKey': this.serverApiKey,
                'Authorization': 'Bearer ' + this.accessToken
            ...
            .pipe(
                catchError(this.handleError<any>('Watchlist/GetWatchlists'))
            );
    }

    /** POST: Add New WatchList Data */
    addWatchListData(requestObj: any): Observable<any> {
        let config = this.configService.readConfig();
        if (config) {
            this.baseUrl = config.apiUrl;
            this.serverApiKey = config.serverApiKey;
        ...
        return this.http.post<any>(this.baseUrl + "/optionapi/v1/Watchlist/AddWatchlist", requestObj, {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
                //'ApiKey': this.serverApiKey,
                'Authorization': 'Bearer ' + this.accessToken
        ...
        .pipe(
            catchError(this.handleError<any>('Watchlist/AddWatchlist'))
        );
    }    

    /** POST: Remove WatchList Data */
    removeWatchListData(requestObj: any): Observable<any> {
        let config = this.configService.readConfig();
        if (config) {
            this.baseUrl = config.apiUrl;
            this.serverApiKey = config.serverApiKey;
        ...
        return this.http.post<any>(this.baseUrl + "/optionapi/v1/Watchlist/RemoveWatchlist", requestObj, {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
                //'ApiKey': this.serverApiKey,
                'Authorization': 'Bearer ' + this.accessToken
        ...
        .pipe(
            catchError(this.handleError<any>('Watchlist/RemoveWatchlist'))
        );
    }
}  