...
export class AnalysisFilterComponent implements OnInit {
  ...
  DecimalList: number[];     
  ErrorRangeList: number[]; 
  StepNumberList: number[];       //max 100 step 5
  VolatilityList: number[]; 
  BetaDataList: number[]      //max 5 step 0.05
  ...
  constructor(
    ...
    this.BetaDataList = this.getBetaDataList();
  }
