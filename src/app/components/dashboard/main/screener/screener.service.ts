...
import { GetScreenerDataRequest } from 'src/app/interface/screener-table-data';
...
export class ScreenerService {
    ...
    /** POST: Get Screener Result */
    getScreenerData(requestObj: GetScreenerDataRequest): Observable<GetScreenerDataResult> {
        ...
        return this.http.post<GetScreenerDataResult>(this.baseUrl + "/optionapi/v1/Screener/GetScreenerData", requestObj, {
            ...
            .pipe(
                catchError(this.handleError<GetScreenerDataResult>('Screener/GetScreenerData'))
            );
    }
    ...
    /** GET: Get PremiumUser Result */
    IsPremiumUser(): Observable<ScreenerResult> {
        let config = this.configService.readConfig();
        if (config) {
            this.baseUrl = config.apiUrl;
            this.serverApiKey = config.serverApiKey;
        ...
        return this.http.get<ScreenerResult>(this.baseUrl + "/optionapi/v1/Screener/IsPremiumUser",  {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
                //'ApiKey': this.serverApiKey,
                'Authorization': 'Bearer ' + this.accessToken
